...
//
// ⚠️ FIELD MAPPING:
//   DB: verdict           → Component: sector_verdict
//   DB: ai_generated_at   → Component: generated_at
//   DB: ai_commentary     → Component: ai_commentary (string)
//
...
export interface SectorSnapshot {
  ...
  // Risk Analysis (JSONB — generated by cron, served from cache)
  risk_analysis: {
...
/**
 * Helper: Convert sector name → sector_snapshots.id
 */
