...
// Re-exported from shared/ for backward-compat with mentor-internal callers
// that import mapSpaceError directly from this module.
export { mapSpaceError } from '@/features/shared/utils/spaceError';
