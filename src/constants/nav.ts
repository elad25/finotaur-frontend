...
export const domains: Record<string, Domain> = {
  ...
  journal: {
    ...
    subNav: [
      ...
      { label: 'Backtest',    path: '/app/backtest/auto', locked: true },
  ...
  'journal-backtest': {
    ...
    sidebar: [
      ...
      { label: 'Chart',            path: '/app/backtest/chart',            icon: FlaskConical },
      ...
      { label: 'Analytics',        path: '/app/backtest/analytics',        icon: BarChart3 },
    ],
  },
