// src/pages/landing/TopSecretLanding.tsx
...
const TopSecretLanding = () => {
  ...
  useEffect(() => {
    if (!isLoading && user) {
      console.log('[TopSecretLanding] ✅ User is authenticated, redirecting to dashboard...');
...
export default TopSecretLanding;
