...
export default function CryptoSentiment() {
  const breadcrumbs = useMemo(() => [
    ...
    { title: "Crypto", to: "/app/crypto/overview" }, { title: "Sentiment", to: "/app/crypto/sentiment" }
  ], []);
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <h1 className="text-xl font-semibold">Crypto — Sentiment</h1>
      <div className="rounded-xl border border-border/40 p-4">
        <p className="text-sm opacity-80">This is the Crypto — Sentiment page. Hook up your data source here.</p>
