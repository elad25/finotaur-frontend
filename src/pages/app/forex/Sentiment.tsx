...
export default function ForexSentiment() {
  const breadcrumbs = useMemo(() => [
    ...
    { title: "Forex", to: "/app/forex/overview" }, { title: "Sentiment", to: "/app/forex/sentiment" }
  ], []);
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <h1 className="text-xl font-semibold">Forex — Sentiment</h1>
      <div className="rounded-xl border border-border/40 p-4">
        <p className="text-sm opacity-80">This is the Forex — Sentiment page. Hook up your data source here.</p>
