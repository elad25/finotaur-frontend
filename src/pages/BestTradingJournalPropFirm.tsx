...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. Every new account automatically gets 14 days of full access to Trader and Investor features — no card required — so you can connect your accounts and see your journal before paying. Afterwards you keep a free plan with 10 manual trades and preview mode.",
  },
  {
    question: "How much does it cost?",
    answer:
      "Every new account automatically gets 14 days of full access to Trader and Investor features — no card required. Afterwards you keep a free plan with 10 manual trades and preview mode. Paid plans start when you upgrade: Trader is $44.99/month and adds unlimited trades, multiple broker connections, the AI trading coach, and the Finotaur Score.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-surface-base">
      ...
      <SEO
        ...
        description="A trading journal for prop firm and funded traders: track multiple evaluation and funded accounts, measure consistency and discipline, and get AI feedback. Built futures-first. 14 days of full access at signup, no card required."
