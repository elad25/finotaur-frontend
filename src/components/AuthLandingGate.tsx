...
// brief wait costs a real user nothing. (Verified 2026-07-13 on a Pages preview:
// graceElapsed flips at 6s, isLoading at ~0.3s — the loader holds the whole
// window instead of bouncing.)
// =====================================================
