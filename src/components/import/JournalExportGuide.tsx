    ...
    slides: [
      {
        ...
        // ?v=5 cache-buster: bump whenever the underlying PNGs change so returning
        // clients fetch the new file instead of the disk-cached old copy.
        imageSrc: '/import-guides/tradezella/01-trade-view.png?v=5',
        secondaryImageSrc: '/import-guides/tradezella/01-trade-view-zoom.png?v=5',
