...
import { ArrowRight, LogIn, Lock, TrendingUp } from "lucide-react";
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-8 relative z-10 w-full">
        ...
        >
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#C9A646]/10 border border-[#C9A646]/30 rounded-full backdrop-blur-xl">
            ...
            <span className="text-[#C9A646] font-semibold text-sm tracking-wide">Professional Trading Intelligence Platform</span>
          </div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-10">
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h1 className="text-6xl lg:text-7xl xl:text-8xl font-semibold leading-[1.05] tracking-tight">
            ...
            <motion.p
              ...
              className="text-2xl text-slate-300 leading-relaxed font-light max-w-xl"
            >
