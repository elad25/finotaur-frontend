// src/components/common/AiToolErrorFallback.tsx
// Generic fallback shown when an AI tool page ErrorBoundary catches a render error.

import React from 'react';
import { AlertTriangle } from 'lucide-react';

export function AiToolErrorFallback() {
  return (
    <div className="flex min-h-[40vh] items-center justify-center p-8">
      <div className="w-full max-w-md rounded-2xl border border-gold-primary/20 bg-section-base p-8 text-center shadow-[0_18px_54px_rgba(0,0,0,0.4)]">
        ...
        <h2 className="mb-2 text-xl font-bold text-ink-primary">Something went wrong</h2>

        <p className="mb-6 text-sm leading-relaxed text-ink-tertiary">
          This AI tool failed to load. Please reload the page.
        </p>
