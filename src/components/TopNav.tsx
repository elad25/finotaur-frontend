              ...
              >
                ...
                >
                  <svg
                    ...
                    className="w-9 h-9"
                  >
                    <path d="M12 4.2c-2.5 0-4.4 2-4.4 4.7s1.9 4.9 4.4 4.9 4.4-2.2 4.4-4.9S14.5 4.2 12 4.2z" />
                    <path d="M12 14.6c-4.5 0-8.1 2.9-8.5 6.7-.06.6.4 1.1 1 1.1h15c.6 0 1.06-.5 1-1.1-.4-3.8-4-6.7-8.5-6.7z" />
                  </svg>
                </div>
