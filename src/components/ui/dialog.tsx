...
function hasDialogPart(children: React.ReactNode, displayName: string): boolean {
  return React.Children.toArray(children).some((child) => {
    ...
    return hasDialogPart(element.props.children, displayName);
  });
}
...
const DialogContent = React.forwardRef((
  ...
  const hasDescription =
    ...
    hasDialogPart(children, DialogPrimitive.Description.displayName);
